;;; counsel-web-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "counsel-web" '("counsel-web-"))

;;;***

;;;### (autoloads nil nil ("counsel-web-pkg.el") (0 0 0 0))
